...
var getBulkImageDatad = function() {
            ...
            var jqxhr = null,
                q = async.queue(function(task, callback) {
                    ...
                    jqxhr = $.ajax({
                        ...
                        } else data.error && wp_way2_msgs.any_fur === data.error && $way2enjoyedSizeColumn.text("No savings found.")
    ...
    $("body").on("click", ".way2enjoy-item-details", function(e) {
        var id = $(this).data("id");
        return $(".tipsy").remove(), id == activeId ? (activeId = null, void $(this).text("Show details")) : ($(".way2enjoy-item-details").text("Show details"), $(this).tipsy("show"), void $(this).text("Hide details"))
        ...
        if (reset) {
            var $resetButton = $(this);
            $resetButton.text("Resetting images, pleaes wait...").attr("disabled", !0);
            var resetData = {
        ...
        var $button = $(this),
            $parent = $(this).parent();
        data.id = $(this).data("id"), $button.text("Optimizing image...").attr("disabled", !0).css({
            opacity: .5
