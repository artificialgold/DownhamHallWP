...
<img src="/wp-content/plugins/way2enjoy-compress-images/css/dist/spinner.svg" class="wd-img-loader" ></div>
	<form method="post" id="<?php echo $way2_options->prefix; ?>_deactivate_form">
		...
		<div class="wd-deactivate-popup-body">
			...
			<div class="<?php echo $way2_options->prefix; ?>_additional_details_wrap"></div>
                 ...
                 <i><b>You will continue to get 1000 free credit every month & unused credit will be forwarded to next month & will never expire.Come back soon :(</b></i>
