...
//// LESS CONFIGURATION BEGINS
		public static function less_variables( $vars ) { 
			...
			// Basic Colors ( ok )
			$vars['wp-brand-primary']    = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-brand-primary', '#6FB586' );
			$vars['wp-brand-secondary']  = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-brand-secondary', '#c5bc58' );
			$vars['wp-body-bg']          = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-body-bg', '#f4f4f4' );
			$vars['wp-text-color']       = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-text-color', '#323232' );
			$vars['wp-link-color']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-link-color', 'regular', '#6FB586');
			$vars['wp-link-hover-color'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-link-color', 'hover', '#498F60');
			
			// Color Sets > Primary ( ok )
			$vars['wp-primary-section-txtcolor']        = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-primary-section-txtcolor', '#fdfdfd' );
			$vars['wp-primary-section-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-primary-section-linkcolor', 'regular', '#fdfdfd');
			$vars['wp-primary-section-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-primary-section-linkcolor', 'hover', '#ffffff');

			// Color Sets > Secondary ( ok )
			$vars['wp-secondary-section-txtcolor']        = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-secondary-section-txtcolor', '#ffffff' );
			$vars['wp-secondary-section-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-secondary-section-linkcolor', 'regular', '#fdfdfd');
			$vars['wp-secondary-section-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-secondary-section-linkcolor', 'hover', '#ffffff');

			// Color Sets > Light ( ok )
			$vars['wp-light-section-bgcolor']         = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-light-section-bgcolor', '#efefef' );
			$vars['wp-light-section-txtcolor']        = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-light-section-txtcolor', '#323232' );
			$vars['wp-light-section-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-light-section-linkcolor', 'regular', '#6FB586');
			$vars['wp-light-section-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-light-section-linkcolor', 'hover', '#498F60');

			// Color Sets > Dark ( ok )
			$vars['wp-dark-section-bgcolor']         = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-dark-section-bgcolor', '#274c33' );
			$vars['wp-dark-section-txtcolor']        = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-dark-section-txtcolor', '#ffffff' );
			$vars['wp-dark-section-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-dark-section-linkcolor', 'regular', '#fdfdfd');
			$vars['wp-dark-section-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-dark-section-linkcolor', 'hover', '#ffffff');

			// Color Sets > White ( ok )
			$vars['wp-white-section-bgcolor']         = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-white-section-bgcolor', '#ffffff' );
			$vars['wp-white-section-txtcolor']        = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-white-section-txtcolor', '#323232' );
			$vars['wp-white-section-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-white-section-linkcolor', 'regular', '#6FB586');
			$vars['wp-white-section-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-white-section-linkcolor', 'hover', '#498F60');

			// Color Sets > Black ( ok )
			$vars['wp-black-section-bgcolor']         = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-black-section-bgcolor', '#000000' );
			$vars['wp-black-section-txtcolor']        = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-black-section-txtcolor', '#ffffff' );
			$vars['wp-black-section-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-black-section-linkcolor', 'regular', '#6FB586');
			$vars['wp-black-section-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-black-section-linkcolor', 'hover', '#498F60');
			...
			$vars['wp-loader-bgcolor']                  = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-page-loader-bgcolor', '#000000' );
			...
			$vars['wp-header-bgcolor']                 = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-header-bgcolor', '#000000' );
			$vars['wp-header-txtcolor']                = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-header-txtcolor', '#ffffff' );
			$vars['wp-header-linkcolor']               = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-header-linkcolor', 'regular', '#ffffff');
			$vars['wp-header-linkcolor-hover']         = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-header-linkcolor', 'hover', '#ffffff');
			...
			$vars['wp-stickyheader-bgcolor']         = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-header-sticky-custom-bgcolor', '#000000' );
			$vars['wp-stickyheader-txtcolor']        = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-header-sticky-custom-txtcolor', '#ffffff' );
			$vars['wp-stickyheader-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-header-sticky-custom-linkcolor', 'regular', '#ffffff');
			$vars['wp-stickyheader-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-header-sticky-custom-linkcolor', 'hover', '#ffffff');
			...
			// Main Section ( ok )
			$vars['wp-footer-bgcolor']         = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-footer-bgcolor', '#16161D'  );
			$vars['wp-footer-txtcolor']        = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-footer-txtcolor', '#fdfdfd' );
			$vars['wp-footer-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-footer-linkcolor', 'regular', '#6FB586');
			$vars['wp-footer-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-footer-linkcolor', 'hover', '#7CC293');
			...
			$vars['wp-woo-minicart-cart-count-color']   = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-woo-minicart-cart-count-color', '#ffffff' );
			$vars['wp-woo-minicart-cart-count-bgcolor'] = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-woo-minicart-cart-count-bgcolor', '#2ecc71' );
