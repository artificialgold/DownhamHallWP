	...
	2. 	You may use, any of the values below to create your own markup. 
		...
		=======================================================================
			...
			{{# items }}							Items loop starts
				...
				{{{ item_comments_link }}} 			Comments link on single post view ( if comments count more than zero )
				{{{ item_comments_text }}} 			Comments count text ( always a translatable 'comments' string, if comments count more than zero )
